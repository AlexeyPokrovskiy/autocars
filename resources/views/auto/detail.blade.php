...
@section('meta_description',"CARSTOCK.COM.UA — купить новые и б/у автомобилей. Продаю Купить ".$car->mark->name." ".$car->model->name." ".(isset($car->city->title_ru)?$car->region->title_ru." город ".$car->city->title_ru:"")." ".$car->year." ".$car->fuel->name." ".@$car->core->volume." ".@$car->core->body." бу в Украине, цена ".$car->price."$ Авторынок онлайн. Автобазар, крупнейший в Украине, все обьявления. Обьявления продажи авто. Каталоги автомобилей и продавцов на карсток.")
@section('content')
