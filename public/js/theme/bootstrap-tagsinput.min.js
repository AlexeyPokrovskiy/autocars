  ...
  b.prototype = {
    ...
    add: function add(b, c, d) {
      ...
      if (!(f.options.maxTags && f.itemsArray.length >= f.options.maxTags) && (b === !1 || b)) {
        if ("string" == typeof b && f.options.trimValue && (b = a.trim(b)), "object" == _typeof(b) && !f.objectItems) throw "Can't add objects when itemValue option is not set";
          ...
          if (!n || f.options.allowDuplicates) {
            if (!(f.items().toString().length + b.length + 1 > f.options.maxInputLength)) {
              ...
              if (f.$element.trigger(o), !o.cancel) {
                f.itemsArray.push(b);
                var p = a('<span class="tag ' + e(l) + (null !== m ? '" title="' + m : "") + '">' + e(k) + '<span data-role="remove" class="tag-remove"></span></span>');
    ...
    remove: function remove(b, c, d) {
      ...
      if (e.objectItems && (b = "object" == _typeof(b) ? a.grep(e.itemsArray, function (a) {
...
/***/ 2:
/*!*************************************************************!*\
  !*** multi ./resources/js/theme/bootstrap-tagsinput.min.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\OSPanel\domains\autocar\resources\js\theme\bootstrap-tagsinput.min.js */"./resources/js/theme/bootstrap-tagsinput.min.js");
